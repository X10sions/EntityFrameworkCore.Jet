...
namespace EntityFrameworkCore.Jet.Update.Internal {
    ...
    public class JetModificationCommandBatch : AffectedCountModificationCommandBatch {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public JetModificationCommandBatch(ModificationCommandBatchFactoryDependencies dependencies) : base(dependencies) {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        //protected override bool CanAddCommand(IReadOnlyModificationCommand modificationCommand) => ModificationCommands.Count < MaxRowCount;
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        //protected override int GetParameterCount() => 1;
    }
}
