...
namespace EntityFrameworkCore.Jet.Update.Internal {
  ...
  public class JetUpdateSqlGenerator : UpdateSqlGenerator, IJetUpdateSqlGenerator {
    ...
    //  commandStringBuilder.Append("@@ROWCOUNT = ").Append(expectedRowsAffected.ToString(CultureInfo.InvariantCulture));
    //}
    ...
    //      commandStringBuilder.Append("SELECT @@ROWCOUNT").Append(SqlGenerationHelper.StatementTerminator).AppendLine().AppendLine();
